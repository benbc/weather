...
<body>
    ...
    def test_last_updated_timestamp_format(self):
        ...
        try:
            with patch('weather.renderer.datetime') as mock_datetime:
                mock_now = datetime(2025, 1, 7, 12, 30, 45, tzinfo=timezone.utc)
    ...
    def test_file_encoding_utf8(self):
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.html', delete=False, encoding='utf-8') as template_file:
            template_file.write(template_content)
            template_path = template_file.name
    ...
    def test_template_not_found_raises_exception(self):
        ...
        with pytest.raises(FileNotFoundError):
            render_html("/nonexistent/template.html", "/tmp/output.html", forecast_date="Test")
